...
import { activeProviderConfig, checkAdminAuth, checkHealth, getNodes, getProviders } from '../../../api/supervisorClient';
...
export const GeneralSettingsPage = () => {
  ...
  const loadAdminData = async (token: string) => {
    ...
    try {
      setModelConfig(activeProviderConfig(await getProviders(token)));
